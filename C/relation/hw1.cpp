...
main()
{
      int i,j,k,m,l,key=-1,temp1,temp2,check1,check2,result;
      int count[10],c2=0;    
      //****initial storing array and state count array***********
      int E[10][10][10];  
      for (i=0;i<10;i++)
      {
          for (j=0;j<10;j++)
               ...
               /*        printf("##%i##%i##\n ",temp1,temp2);
                  ...
                  */                             
                          ...
                          {                                
                                ...
                                {
                                    count[i+1]=l+1;     //increase # of state
                                    E[i+1][count[i+1]-1][0] = E[i][j][k]; 
                                                                       
                                }
                                else                          //have increased the # of state already
                                {
