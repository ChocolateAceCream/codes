...
# Active Directory Task Starts  
    ...
    write-Host "Getting users created within XXX days" 
...
# Find All Users those are created with in XXX days
        ...
        $s2.name = "User Created in XXX days" 
 
#  Add information ot sheet 2 
        $cells= $s2.Cells 
        $s2.range("C1:C1").font.bold = "true" 
        $s2.range("C1:C1").font.size=18 
        $s2.range("C1:C1").cells="List of Active Directory User Account those are created with-in XXX days." 
